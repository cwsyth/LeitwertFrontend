...
export type CountryPointProperties = {
  COUNTRY: string;
  ISO: string;
  COUNTRYAFF: string;
  AFF_ISO: string;
...
export type CountryMiddlepointFeature = Feature<Point, CountryPointProperties>;
export type CountryMiddlepointFeatureCollection = FeatureCollection<Point, CountryPointProperties>;

export const countryMiddlepoints: CountryMiddlepointFeatureCollection = {
