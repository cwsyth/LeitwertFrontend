export default function Footer() {
  return (
    <footer className="main-footer flex items-center justify-center m-4">
        <div className="max-w-[var(--content-max-width)] w-full flex items-center justify-between text-white">
            ...
            <span className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl px-4 py-3 shadow-xl">Dashboard v1.0</span>
        </div>
    </footer>
  );
}
